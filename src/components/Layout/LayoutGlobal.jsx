...
export default function LayoutGlobal({
  ...
  return (
    <>
      ...
      <footer class='bg-white dark:bg-[#2D3250]'>
        <div class='mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8'>
          <div class='md:flex md:justify-between'>
            <div class='mb-6 md:mb-0'>
              <a href='https://rauston.se/' class='flex items-center'>
            ...
            <div class='grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6'>
              <div>
                ...
                <ul class='font-medium text-gray-500 dark:text-gray-400'>
                  <li class='mb-4'>
                    <a class='hover:underline'>Lorem Ipsum</a>
                  </li>
                  <li>
                    <a class='hover:underline'>Lorem Ipsum</a>
                  </li>
          ...
          <div class='sm:flex sm:items-center sm:justify-between'>
            <span class='text-sm text-gray-500 sm:text-center dark:text-gray-400'>
              © 2024{' '}
              <a href='https://rauston.se/' class='hover:underline'>
                Indilens™
              </a>
              . All Rights Reserved.
            </span>
